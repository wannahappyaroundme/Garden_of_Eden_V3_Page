  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-zinc-950 to-zinc-900">
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-zinc-800 rounded-full mb-6">
            ...
            <span className="text-white font-semibold">{t('legal.termsOfService.badge')}</span>
          </div>
      ...
      <section className="py-16 px-6 bg-zinc-950">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12 text-white">{t('legal.termsOfService.keyPoints.title')}</h2>
          <div className="grid md:grid-cols-3 gap-6">
            <div className="p-6 rounded-xl bg-gradient-to-br from-zinc-900 to-zinc-800 border border-zinc-800">
              <div className="text-3xl mb-3">✅</div>
              <h3 className="font-bold mb-2 text-white">{t('legal.termsOfService.keyPoints.point1.title')}</h3>
              <p className="text-sm text-gray-400">{t('legal.termsOfService.keyPoints.point1.description')}</p>
            </div>
            <div className="p-6 rounded-xl bg-gradient-to-br from-zinc-900 to-zinc-800 border border-zinc-800">
              <div className="text-3xl mb-3">🔒</div>
              <h3 className="font-bold mb-2 text-white">{t('legal.termsOfService.keyPoints.point2.title')}</h3>
              <p className="text-sm text-gray-400">{t('legal.termsOfService.keyPoints.point2.description')}</p>
            </div>
            <div className="p-6 rounded-xl bg-gradient-to-br from-zinc-900 to-zinc-800 border border-zinc-800">
              <div className="text-3xl mb-3">⚖️</div>
              <h3 className="font-bold mb-2 text-white">{t('legal.termsOfService.keyPoints.point3.title')}</h3>
              <p className="text-sm text-gray-400">{t('legal.termsOfService.keyPoints.point3.description')}</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-zinc-900 to-black">
        <div className="max-w-4xl mx-auto space-y-8">
          {sections.map((item, index) => (
            <div
              key={index}
              className="group relative p-8 rounded-2xl bg-zinc-950 border border-zinc-800 hover:shadow-xl transition-all duration-300"
            >
      ...
      <section className="py-20 px-6 bg-black">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6 text-white">{t('legal.termsOfService.contact.title')}</h2>
          <p className="text-lg text-gray-400 mb-8">
            {t('legal.termsOfService.contact.description')}
          </p>
          <div className="inline-flex flex-col gap-2 p-6 bg-gradient-to-br from-zinc-900 to-zinc-800 rounded-xl border border-zinc-800">
