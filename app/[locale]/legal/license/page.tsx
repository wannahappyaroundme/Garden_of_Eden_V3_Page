        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="p-6 bg-white/80 backdrop-blur-sm rounded-xl border border-purple-200/60 hover:border-purple-300 hover:shadow-xl hover:shadow-purple-200/50 transition-all duration-300">
              ...
              <p className="font-semibold text-gray-900">{t('legal.license.philosophy.value1')}</p>
            </div>
            <div className="p-6 bg-white/80 backdrop-blur-sm rounded-xl border border-purple-200/60 hover:border-purple-300 hover:shadow-xl hover:shadow-purple-200/50 transition-all duration-300">
              <div className="text-3xl mb-3">🔓</div>
              <p className="font-semibold text-gray-900">{t('legal.license.philosophy.value2')}</p>
            </div>
            <div className="p-6 bg-white/80 backdrop-blur-sm rounded-xl border border-purple-200/60 hover:border-purple-300 hover:shadow-xl hover:shadow-purple-200/50 transition-all duration-300">
              <div className="text-3xl mb-3">🤝</div>
              <p className="font-semibold text-gray-900">{t('legal.license.philosophy.value3')}</p>
            </div>
          </div>
        </div>
      </section>
