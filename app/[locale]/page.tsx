    ...
    <main className="min-h-screen bg-neutral-50">
        ...
        <div className="relative z-10 max-w-2xl mx-auto px-6 py-20 text-center">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-semibold">{t('hero.privacyBadge')}</span>
            </motion.div>
      ...
      <section className="max-w-7xl mx-auto py-24 px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {[
            { icon: '❤️', title: t('pillars.loneliness.title'), desc: t('pillars.loneliness.description') },
            { icon: '🤝', title: t('pillars.support.title'), desc: t('pillars.support.description') },
            { icon: '⚡', title: t('pillars.productivity.title'), desc: t('pillars.productivity.description') }
          ].map((pillar, idx) => (
            <motion.div
              key={idx}
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <h3 className="text-3xl font-bold mb-8 text-gray-900">{t('problemSolution.problems.title')}</h3>
              {[
                { title: t('problemSolution.problems.noEmotional'), desc: t('problemSolution.problems.noEmotionalDesc') },
                { title: t('problemSolution.problems.privacy'), desc: t('problemSolution.problems.privacyDesc') },
                { title: t('problemSolution.problems.expensive'), desc: t('problemSolution.problems.expensiveDesc') },
                { title: t('problemSolution.problems.internet'), desc: t('problemSolution.problems.internetDesc') },
                { title: t('problemSolution.problems.generic'), desc: t('problemSolution.problems.genericDesc') },
                { title: t('problemSolution.problems.limited'), desc: t('problemSolution.problems.limitedDesc') }
              ].map((problem, idx) => (
            ...
            >
              ...
              {[
                { title: t('problemSolution.solutions.emotional'), desc: t('problemSolution.solutions.emotionalDesc') },
                { title: t('problemSolution.solutions.privacy'), desc: t('problemSolution.solutions.privacyDesc') },
                { title: t('problemSolution.solutions.free'), desc: t('problemSolution.solutions.freeDesc') },
                { title: t('problemSolution.solutions.offline'), desc: t('problemSolution.solutions.offlineDesc') },
                { title: t('problemSolution.solutions.learns'), desc: t('problemSolution.solutions.learnsDesc') },
                { title: t('problemSolution.solutions.integration'), desc: t('problemSolution.solutions.integrationDesc') }
              ].map((solution, idx) => (
                <div key={idx} className="flex gap-4">
                  <span className="text-2xl flex-shrink-0">✅</span>
                  <div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-12">
            {[
              ...
              >
                <div className="text-6xl md:text-7xl font-bold mb-4">{stat.num}</div>
              ...
              <div className="text-center">
                ...
                <ul className="space-y-3 text-left max-w-xl mx-auto">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-gray-700">{t('features.privacy.item1')}</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-green-500 text-xl flex-shrink-0">✓</span>
                    <span className="text-gray-700">{t('features.privacy.item2')}</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-green-500 text-xl flex-shrink-0">✓</span>
                    <span className="text-gray-700">{t('features.privacy.item3')}</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-green-500 text-xl flex-shrink-0">✓</span>
                    <span className="text-gray-700">{t('features.privacy.item4')}</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-green-500 text-xl flex-shrink-0">✓</span>
                    <span className="text-gray-700">{t('features.privacy.item5')}</span>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="text-center">
                ...
                <ul className="space-y-3 text-left max-w-xl mx-auto">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-gray-700">{t('features.aiModels.item1')}</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-blue-500 text-xl flex-shrink-0">◆</span>
                    <span className="text-gray-700">{t('features.aiModels.item2')}</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-blue-500 text-xl flex-shrink-0">◆</span>
                    <span className="text-gray-700">{t('features.aiModels.item3')}</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-blue-500 text-xl flex-shrink-0">◆</span>
                    <span className="text-gray-700">{t('features.aiModels.item4')}</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-blue-500 text-xl flex-shrink-0">◆</span>
                    <span className="text-gray-700">{t('features.aiModels.item5')}</span>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="text-center">
                ...
                <ul className="space-y-3 text-left max-w-xl mx-auto">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-gray-700">{t('features.persona.item1')}</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-purple-500 text-xl flex-shrink-0">★</span>
                    <span className="text-gray-700">{t('features.persona.item2')}</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-purple-500 text-xl flex-shrink-0">★</span>
                    <span className="text-gray-700">{t('features.persona.item3')}</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-purple-500 text-xl flex-shrink-0">★</span>
                    <span className="text-gray-700">{t('features.persona.item4')}</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-purple-500 text-xl flex-shrink-0">★</span>
                    <span className="text-gray-700">{t('features.persona.item5')}</span>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="text-center">
                ...
                <ul className="space-y-3 text-left max-w-xl mx-auto">
                  <li className="flex items-start gap-3">
                    ...
                    <span className="text-gray-700">{t('features.emotional.item1')}</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-pink-500 text-xl flex-shrink-0">♥</span>
                    <span className="text-gray-700">{t('features.emotional.item2')}</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-pink-500 text-xl flex-shrink-0">♥</span>
                    <span className="text-gray-700">{t('features.emotional.item3')}</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-pink-500 text-xl flex-shrink-0">♥</span>
                    <span className="text-gray-700">{t('features.emotional.item4')}</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-pink-500 text-xl flex-shrink-0">♥</span>
                    <span className="text-gray-700">{t('features.emotional.item5')}</span>
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="max-w-2xl mx-auto px-6">
          ...
          <Carousel autoPlay interval={13000}>
            {[
              ...
              { name: t('personas.cheerfulFriend.name'), desc: t('personas.cheerfulFriend.description'), details: t('personas.cheerfulFriend.details'), icon: '🎉' },
              { name: t('personas.professional.name'), desc: t('personas.professional.description'), details: t('personas.professional.details'), icon: '💼' },
            ...
            <table className="w-full bg-white/70 backdrop-blur-xl rounded-2xl md:rounded-[40px] shadow-lg overflow-hidden border border-white/50">
              <thead className="bg-gradient-to-r from-purple-500/85 via-violet-500/85 to-indigo-500/85 text-white backdrop-blur-sm">
                <tr>
                  ...
                  <th className="py-4 px-6 text-center font-bold">{t('comparison.chatgptPlus')}</th>
                  <th className="py-4 px-6 text-center font-bold">{t('comparison.claudePro')}</th>
                  <th className="py-4 px-6 text-center font-bold">{t('comparison.githubCopilot')}</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200">
                {[
                  { feature: t('comparison.emotionalCompanionship'), eden: '✅', gpt: '❌', claude: '❌', copilot: '❌' },
                  { feature: t('comparison.privacy'), eden: '✅ 100%', gpt: '❌', claude: '❌', copilot: '❌' },
                  { feature: t('comparison.costPerYear'), eden: '$0', gpt: '$240', claude: '$240', copilot: '$100' },
                  { feature: t('comparison.worksOffline'), eden: '✅', gpt: '❌', claude: '❌', copilot: '❌' },
                  { feature: t('comparison.personaCustomization'), eden: '✅ ' + t('comparison.personaParams'), gpt: '❌', claude: '❌', copilot: '❌' },
                  { feature: t('comparison.adaptiveLearning'), eden: '✅', gpt: '❌', claude: '❌', copilot: '⚠️' },
                  { feature: t('comparison.deepIntegration'), eden: '✅', gpt: '❌', claude: '❌', copilot: '⚠️' },
                  { feature: t('comparison.openSource'), eden: '✅ MIT', gpt: '❌', claude: '❌', copilot: '❌' },
                  { feature: t('comparison.humanEvalScore'), eden: '80.5%', gpt: '85%', claude: '88%', copilot: '~85%' },
                  { feature: t('comparison.responseTime'), eden: '2-4s', gpt: '~1s', claude: '~1s', copilot: '<1s' },
                  { feature: t('comparison.voiceSupport'), eden: '✅', gpt: '✅', claude: '❌', copilot: '❌' },
                  { feature: t('comparison.screenContext'), eden: '✅', gpt: '❌', claude: '❌', copilot: '❌' },
                  { feature: t('comparison.ragMemory'), eden: '✅', gpt: '⚠️', claude: '⚠️', copilot: '❌' }
                ].map((row, idx) => (
                  <tr key={idx} className="hover:bg-gray-50 transition-colors">
                    <td className="py-4 px-6 font-semibold text-gray-900">{row.feature}</td>
                    <td className="py-4 px-6 text-center font-bold text-green-600">{row.eden}</td>
                    <td className="py-4 px-6 text-center text-gray-600">{row.gpt}</td>
                    <td className="py-4 px-6 text-center text-gray-600">{row.claude}</td>
                    <td className="py-4 px-6 text-center text-gray-600">{row.copilot}</td>
                  </tr>
                ))}
              </tbody>
            </table>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-12 mb-12">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm mb-2">{t('footer.licenseDesc')}</p>
