          ...
          <div className="grid md:grid-cols-3 gap-8">
            {pillars.map((pillar, index) => (
              ...
              >
                ...
                <h3 className="text-2xl font-bold mb-3 text-gray-900">{t(`productOverview.threePillars.pillar${index + 1}.title`)}</h3>
                <p className="text-gray-700">{t(`productOverview.threePillars.pillar${index + 1}.description`)}</p>
              </div>
            ))}
          </div>
        </div>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {problems.map((item, index) => (
                ...
                >
                  ...
                  <p className="font-semibold text-red-700">{t(`productOverview.problemSolution.problem${index + 1}`)}</p>
                </div>
              ))}
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {solutions.map((item, index) => (
                ...
                >
                  ...
                  <h4 className="font-bold text-lg mb-2 text-gray-900">{t(`productOverview.problemSolution.solution${index + 1}.title`)}</h4>
                  <p className="text-sm text-gray-700">{t(`productOverview.problemSolution.solution${index + 1}.description`)}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <section className="py-20 px-6 bg-radial-white-center">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-2xl leading-relaxed text-gray-700">
            {t('productOverview.visionSection.visionText2')} <span className="font-bold underline text-purple-700">{t('productOverview.visionSection.highlight2')}</span> {t('productOverview.visionSection.visionText3')}
          </p>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="p-6">
              ...
              <p className="font-semibold text-gray-700">{t('productOverview.corePromise.local')}</p>
            </div>
            <div className="p-6">
              <div className="text-5xl font-bold bg-gradient-to-r from-purple-600 to-violet-600 bg-clip-text text-transparent mb-3">{t('productOverview.corePromise.privatePercent')}</div>
              <p className="font-semibold text-gray-700">{t('productOverview.corePromise.private')}</p>
            </div>
            <div className="p-6">
              <div className="text-5xl font-bold bg-gradient-to-r from-purple-600 to-violet-600 bg-clip-text text-transparent mb-3">{t('productOverview.corePromise.cloudPercent')}</div>
              <p className="font-semibold text-gray-700">{t('productOverview.corePromise.cloud')}</p>
            </div>
            <div className="p-6">
              <div className="text-5xl font-bold bg-gradient-to-r from-purple-600 to-violet-600 bg-clip-text text-transparent mb-3">{t('productOverview.corePromise.subscriptionsPercent')}</div>
              <p className="font-semibold text-gray-700">{t('productOverview.corePromise.subscriptions')}</p>
            </div>
          </div>
        </div>
      </section>
