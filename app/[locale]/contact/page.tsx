    ...
    <div className="min-h-screen bg-radial-white">
      ...
      <section className="pt-32 pb-20 px-6 bg-radial-white-center">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-purple-100/50 backdrop-blur-sm border border-purple-200/60 rounded-full mb-6">
            ...
            <span className="text-purple-900 font-semibold">{t('contact.badge')}</span>
          </div>
      ...
      <section className="py-20 px-6 bg-radial-white-purple">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-4 bg-gradient-to-r from-purple-600 via-violet-600 to-purple-500 bg-clip-text text-transparent">{t('contact.methods.title')}</h2>
            ...
            {contactMethods.map((method, index) => (
              ...
              >
                <div className="flex items-start gap-6">
                  <div className={`flex-shrink-0 w-16 h-16 rounded-xl bg-gradient-to-br from-purple-100 to-purple-200 flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
      ...
      <section className="py-20 px-6 bg-radial-white-center">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-4 bg-gradient-to-r from-purple-600 via-violet-600 to-purple-500 bg-clip-text text-transparent">{t('contact.community.title')}</h2>
          <p className="text-center text-gray-700 mb-12 text-lg">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {community.map((item, index) => (
              ...
              >
                <div className={`w-16 h-16 rounded-xl bg-gradient-to-br from-purple-100 to-purple-200 flex items-center justify-center mx-auto mb-4 animate-float`}>
                  <item.icon className="w-8 h-8 text-purple-700" />
                </div>
                <h3 className="text-lg font-bold mb-2 text-gray-900">{t(`contact.community.item${index + 1}.title`)}</h3>
                <p className="text-sm text-gray-700">{t(`contact.community.item${index + 1}.description`)}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 px-6 bg-radial-white-purple">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-6 bg-gradient-to-r from-purple-600 via-violet-600 to-purple-500 bg-clip-text text-transparent">{t('contact.cta.title')}</h2>
